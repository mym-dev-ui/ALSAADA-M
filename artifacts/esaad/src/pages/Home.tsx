...
const cardTypes = [
  {
    id: "silver",
    name_ar: "عضوية فضية",
    eligibility_ar: "للأسرة الإماراتية الجديدة من دون أبناء",
    badge: "bg-gray-100 text-gray-600 border-gray-300",
  },
  {
    id: "gold",
    name_ar: "عضوية ذهبية",
    eligibility_ar: "للأسرة الإماراتية من 1-3 أبناء",
    badge: "bg-yellow-50 text-yellow-700 border-yellow-300",
  },
  {
    id: "platinum",
    name_ar: "عضوية بلاتينية",
    eligibility_ar:
      "للأسرة الإماراتية التي تضم 4 أبناء فأكثر أو التي يكون أحد أفرادها من أصحاب الهمم",
...
const greenGradient = {
  background: "linear-gradient(135deg, #0c6e3e 0%, #7cb342 50%, #0c6e3e 100%)",
};
    ...
    <div className="min-h-screen bg-gray-200" dir="rtl">
      <div className="mx-auto min-h-screen w-full max-w-md bg-white relative overflow-x-hidden sm:shadow-xl">
        ...
        <section className="relative overflow-hidden h-[52vh] min-h-[360px] flex flex-col items-center justify-center">
          ...
          >
            <div className="bg-white rounded-full p-4 shadow-xl">
              <img src={`${BASE}esaad-logo.png`} alt="إسعاد" className="h-20 w-20 object-contain" />
            </div>
            <p className="text-white text-lg font-bold drop-shadow-md text-center">
              بطاقة اسعاد بالتعاون مع إسعاد
            </p>
          </motion.div>
        </section>
        ...
        <section className="bg-white pb-6 pt-4 px-6 text-center">
          <p className="text-base text-[#101828] font-medium mb-1">
            🇦🇪 بطاقة مميّزة للمواطنين والمقيمين
          </p>
          <h1 className="text-2xl font-bold text-[#101828] leading-snug mb-1">
            بطاقة اسعاد لكل الأسر الإماراتية
          </h1>
          <button
            onClick={() => navigate("/register")}
            className="text-xl font-bold text-[#101828] hover:text-[#0c6e3e] transition-colors cursor-pointer underline-offset-2 hover:underline"
          >
            مربوطة بعدد الأبناء
          </button>
        </section>
            ...
            {cardTypes.map((t) => (
              <div key={t.id} className="flex items-start gap-4 px-4 py-4 bg-white">
                <div className="flex-shrink-0 pt-0.5">
                  <span className={`inline-block border px-3 py-1 rounded-full text-sm font-bold ${t.badge}`}>
                    {t.name_ar}
                  </span>
                </div>
          ...
          <div className="relative bg-gray-900 py-8 px-5">
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center mb-6">
                <img src={`${BASE}esaad-about.png`} alt="بطاقات اسعاد" className="w-48 h-auto object-contain drop-shadow-2xl" />
              </div>
